        ...
        <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
          ...
          <nav class="mt-4">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <!-- New Assign Product & Assigned Stock Links -->
              <li class="nav-item">
                <a href="<?php echo base_url ?>admin/stocks/assign.php" class="nav-link nav-assign">
                  <i class="nav-icon fas fa-share"></i>
                  <p>Assign Product</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url ?>admin/stocks/assigned_list.php" class="nav-link nav-assigned_list">
...
<script>
  ...
  $(document).ready(function () {
    ...
    $('#receive-nav').click(function () {
      ...
      uni_modal("Enter Tracking Number...");
    });
  });
</script>
